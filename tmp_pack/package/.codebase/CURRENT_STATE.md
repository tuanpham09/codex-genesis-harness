...
- **TDD & Workflow Strictness**: Introduced 4 new core protocol skills (`genesis-executing-plans`, `genesis-test-driven-development`, `genesis-verification-before-completion`, `genesis-using-git-worktrees`) to enforce Test-Driven Development loops, plan tracking, mandatory verification before task completion, and secure git isolation for disruptive changes.
